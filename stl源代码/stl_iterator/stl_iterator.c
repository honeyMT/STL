...
//为避免写代码时疏忽，自行开发的迭代器最好继承下面这个std::iterator
...
//这个函数可以很方便的帮你决定出某个迭代器的distance type.
template <class Iterator>
...
//这个函数可以很方便的帮你决定出某个迭代器的difference_type.
template <class Iterator>
...
//这个函数可以很方便的帮你决定出某个迭代器的value_type
template <class Iterator>
...
//外层的一个封装，你扔给我什么我就传递进去 然后进行相应的调用.
template <class InputIterator>
inline iterator_traits<InputIterator>::difference_type
